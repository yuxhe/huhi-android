...
CONTENT_EXPORT std::string AddHuhiUserAgentForDDG(const std::string& baseString, const std::string& strHost);
// Makes Huhi user agent string
CONTENT_EXPORT std::string MakeHuhiUserAgent(const std::string& baseString);
