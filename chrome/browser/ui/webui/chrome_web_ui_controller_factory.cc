...
// Special case for HuhiRewardsPageUI
template<>
WebUIController* NewWebUI<HuhiRewardsPageUI>(WebUI* web_ui, const GURL& url) {
  return new HuhiRewardsPageUI(web_ui, url.host());
}


// Special case for HuhiRewardsInternalsUI
template<>
WebUIController* NewWebUI<HuhiRewardsInternalsUI>(WebUI* web_ui, const GURL& url) {
