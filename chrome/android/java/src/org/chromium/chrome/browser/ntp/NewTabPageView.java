...
public class NewTabPageView extends HistoryNavigationLayout {
    ...
    */
    ...
    private ImageView mHuhiStatsShadow;
    ...
    public void initialize(NewTabPageManager manager, Tab tab, TileGroup.Delegate tileGroupDelegate,
        ...
        mHuhiStatsView = (ViewGroup)mNewTabPageLayout.findViewById(R.id.huhi_stats);
        mHuhiStatsShadow = (ImageView)mNewTabPageLayout.findViewById(R.id.huhi_stats_shadow);
    ...
    private void updateHuhiStats() {
        ...
        TextView adsBlockedCountTextView = (TextView) mHuhiStatsView.findViewById(R.id.huhi_stats_text_ads_count);
        TextView httpsUpgradesCountTextView = (TextView) mHuhiStatsView.findViewById(R.id.huhi_stats_text_https_count);
        TextView estTimeSavedTextView = (TextView) mHuhiStatsView.findViewById(R.id.huhi_stats_text_time_count);
        adsBlockedCountTextView.setText(getHuhiStatsStringFormNumber(adsBlockedCount));
        httpsUpgradesCountTextView.setText(getHuhiStatsStringFormNumber(httpsUpgradesCount));
        estTimeSavedTextView.setText(getHuhiStatsStringFromTime(estimatedMillisecondsSaved / 1000));
        TraceEvent.end(TAG + ".updateHuhiStats()");
    }

    /*
    * Gets string view of specific number for Huhi stats
    */
    private String getHuhiStatsStringFormNumber(long number) {
        String result = "";
        String suffix = "";
    ...
    */
    private String getHuhiStatsStringFromTime(long seconds) {
        String result = "";
        if (seconds > 24 * 60 * 60) {
