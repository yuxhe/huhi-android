...
public class HuhiRewardsDonationSentActivity extends Activity implements HuhiRewardsHelper.LargeIconReadyCallback, HuhiRewardsObserver  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIconFetcher = new org.chromium.chrome.browser.HuhiRewardsHelper();
    ...
    private void SetData() {
        ...
        //set the data
        String strAmount = String.format(getDefault(), "%.1f "+(HuhiRewardsHelper.isJapanLocale() ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)), (float)mAmount_);
