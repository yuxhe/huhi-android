...
public class CustomTabToolbar extends ToolbarLayout implements View.OnLongClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mHuhiShieldsButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null != mHuhiShieldsButton && null != mHuhiShieldsListener) {
    ...
    @Override
    public void setHuhiShieldsClickHandler(OnClickListener listener) {
