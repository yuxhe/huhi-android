...
public class MainPreferences extends PreferenceFragmentCompat
    ...
    public static final String PREF_HUHI_REWARDS = "huhi_rewards";
    ...
    private void createPreferences() {
        ...
        welcomeTour.setOnPreferenceClickListener(preference -> {
            ...
            int padding = HuhiRewardsHelper.dp2px(20);
    ...
    private void updatePreferences() {
        ...
        setOnOffSummary(closingTabsPref, ClosingTabsManager.isClosingAllTabsClosesHuhiEnabled());
