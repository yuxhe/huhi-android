 ...
 */
public class HuhiShieldsMenuHandler {
    ...
    private HuhiShieldsMenuAdapter mAdapter;
    ...
    /**
     * Constructs a HuhiShieldsMenuHandler object.
     * @param activity Activity that is using the HuhiShieldsMenu.
     * @param menuResourceId Resource Id that should be used as the source for the menu items.
     */
    public HuhiShieldsMenuHandler(Activity activity, int menuResourceId) {
        mActivity = activity;
    ...
    public void show(View anchorView, boolean incognitoTab, String host, int adsAndTrackers
        ...
        mAdapter = new HuhiShieldsMenuAdapter(menuItems,
            ...
            public void run() {
                ...
                try {
                    ...
                    for (int i = 0; i < list.getChildCount(); i++) {
                        ...
                        TextView menuText = (TextView) menuItemView.findViewById(R.id.huhi_shields_number);
                        if (null == menuText || null == menuText.getTag()) {
                            continue;
                        }
                        if ((int)menuText.getTag() == R.string.huhi_shields_ads_and_trackers) {
                            // Set Ads and Trackers count
                            menuText.setText(String.valueOf(fadsAndTrackers));
                        } else if ((int)menuText.getTag() == R.string.huhi_shields_https_upgrades) {
                            // Set HTTPS Upgrades count
                            menuText.setText(String.valueOf(fhttpsUpgrades));
                        } else if ((int)menuText.getTag() == R.string.huhi_shields_scripts_blocked) {
                            // Set Scripts Blocked count
                            menuText.setText(String.valueOf(fscriptsBlocked));
                        } else if ((int)menuText.getTag() == R.string.huhi_shields_fingerprint_methods) {
