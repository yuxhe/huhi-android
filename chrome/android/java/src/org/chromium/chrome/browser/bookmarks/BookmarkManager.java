...
public class BookmarkManager
    ...
    private final Runnable mModelLoadedRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (null != app && null != app.mHuhiSyncWorker) {
                mBookmarkModel.addObserver(app.mHuhiSyncWorker.mBookmarkModelObserver);
                app.mHuhiSyncWorker.mBookmarkModelObserver.huhiBookmarkModelLoaded(mBookmarkModel);
            }
        }
    };
