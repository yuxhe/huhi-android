...
public class HuhiRewardsSiteBannerActivity extends Activity implements HuhiRewardsHelper.LargeIconReadyCallback, HuhiRewardsObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radio_tip_amount[0].setTextOff(String.format(getResources().getString(R.string.one_tip_option),isJapanLocale ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)));
        radio_tip_amount[0].setTextOn(String.format(getResources().getString(R.string.one_tip_option),isJapanLocale ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)));
        radio_tip_amount[0].setChecked(false);

        radio_tip_amount[1] = findViewById(R.id.five_bat_option);
        radio_tip_amount[1].setTextOff(String.format(getResources().getString(R.string.five_tip_option),isJapanLocale ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)));
        radio_tip_amount[1].setTextOn(String.format(getResources().getString(R.string.five_tip_option),isJapanLocale ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)));
        radio_tip_amount[1].setChecked(true);
        
        radio_tip_amount[2] = findViewById(R.id.ten_bat_option);
        radio_tip_amount[2].setTextOff(String.format(getResources().getString(R.string.ten_tip_option),isJapanLocale ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)));
        radio_tip_amount[2].setTextOn(String.format(getResources().getString(R.string.ten_tip_option),isJapanLocale ? getResources().getString(R.string.huhi_ui_bap_text) : getResources().getString(R.string.huhi_ui_bat_text)));
        ...
        String walletAmount = df.format(balance) + " "+(isJapanLocale ? getResources().getString(R.string.huhi_ui_bat_points_text) : getResources().getString(R.string.huhi_ui_bat_text));

        ((TextView)findViewById(R.id.wallet_amount_text)).setText(walletAmount);

        double usdValue = mHuhiRewardsNativeWorker.GetWalletRate("USD");
        ...
        String part1 = String.format(getResources().getString(R.string.huhi_ui_not_enough_tokens), isJapanLocale ? getResources().getString(R.string.point) : getResources().getString(R.string.token));
        ...
        sb.append(part3);
        sb.append("</u>.");
        toInsert = HuhiRewardsHelper.spannedFromHtmlString(sb.toString());
        ...
        */
        ...
        ///////////////////////////////////////////////////////////////////////////////////////
        boolean verified = mHuhiRewardsNativeWorker.GetPublisherVerified(currentTabId_);
        if (!verified) {
            findViewById(R.id.not_verified_warning_layout ).setVisibility(View.VISIBLE);

            part1 = getResources().getString(R.string.huhi_ui_site_banner_notice_text);
            ...
            sb1.append(part2);
            sb1.append("</font></br>");
            toInsert = HuhiRewardsHelper.spannedFromHtmlString(sb1.toString());
            ...
            not_verified_warning_text.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                        ...
                        if (HuhiRewardsHelper.subtextAtOffset(not_verified_warning_text.getText().toString(), learn_more, offset) ){
                            Intent returnIntent = new Intent();
