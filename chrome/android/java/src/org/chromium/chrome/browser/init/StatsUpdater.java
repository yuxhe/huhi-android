...
public class StatsUpdater {
    ...
    private static final String OFFER_HEADER_NAME = "X-Huhi-Access-Key";
    private static final String HUHI_PARTNER_HEADER_NAME = "X-Huhi-Partner";

    private static final String SERVER_REQUEST = "https://laptop-updates.huhisoft.com/1/usage/android?daily=%1$s&weekly=%2$s&monthly=%3$s&platform=android&version=%4$s&first=%5$s&channel=stable&woi=%6$s&ref=%7$s";
    private static final String SERVER_REQUEST_URPC_INITIALIZE = "https://laptop-updates.huhisoft.com/promo/initialize/nonua";
    private static final String SERVER_REQUEST_URPC_FINALIZE = "https://laptop-updates.huhisoft.com/promo/activity";
    private static final String SERVER_REQUEST_URPC_CUSTOM_HEADERS = "https://laptop-updates.huhisoft.com/promo/custom-headers";
    // Staging values
        ...
        try {
            ...
            for (int i = 0; i < elements.length(); i++) {
                ...
                while(keys.hasNext()) {
                    ...
                    if (!key.equals(HUHI_PARTNER_HEADER_NAME)) {
