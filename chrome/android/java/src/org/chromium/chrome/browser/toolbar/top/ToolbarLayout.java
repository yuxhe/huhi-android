...
public abstract class ToolbarLayout
    ...
    /**
     * Sets the OnClickListener that will be notified when the Huhi Shields button is pressed.
     * @param listener The callback that will be notified when the Huhi Shields button is pressed.
     */
