...
public class NewTabPageLayout extends LinearLayout implements TileGroup.Observer, VrModeObserver {
    ...
    public void initialize(NewTabPageManager manager, ChromeActivity activity,
        ...
        mHuhiStatsView = (ViewGroup) findViewById(R.id.huhi_stats);
        mHuhiStatsShadow = (ImageView) findViewById(R.id.huhi_stats_shadow);
    ...
    public void setSearchProviderInfo(boolean hasLogo, boolean isGoogle) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mHuhiStatsView) continue;
            if (child == mHuhiStatsShadow) continue;
