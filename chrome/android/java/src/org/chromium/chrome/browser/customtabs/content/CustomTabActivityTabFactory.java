    ...
    public TabModelSelectorImpl createTabModelSelector() {
        ...
        mTabModelSelectorTabObserver = new TabModelSelectorTabObserver(mTabModelSelector) {
            ...
            public void onLoadStarted(Tab tab, boolean toDifferentDocument) {
                ...
                if (mActivity.getActivityTab() == tab) {
                    try {
                        ...
                        mActivity.setHuhiShieldsColor(tab.isIncognito(), urlCheck.getHost());
                    } catch (Exception e) {
                        mActivity.setHuhiShieldsBlackAndWhite();
                    }
                }
            ...
            public void onHuhiShieldsCountUpdate(String url, int adsAndTrackers, int httpsUpgrades,
                ...
                mActivity.huhiShieldsCountUpdate(url, adsAndTrackers, httpsUpgrades, scriptsBlocked, fingerprintsBlocked);
            }
        };
