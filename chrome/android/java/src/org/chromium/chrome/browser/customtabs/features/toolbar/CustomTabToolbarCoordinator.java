...
public class CustomTabToolbarCoordinator implements InflationObserver {
    ...
    private void onCompositorContentInitialized(LayoutManager layoutDriver) {
        OnClickListener huhiShieldsClickHandler = new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (currentTab != null) {
                    try {
                        ...
                        mActivity.setHuhiShieldsColor(currentTab.isIncognito(), url.getHost());
                        mActivity.getHuhiShieldsMenuHandler().show((View)mActivity.findViewById(R.id.huhi_shields_button)
        ...
        mToolbarManager.get().initializeWithNative(mTabController.getTabModelSelector(),
                ...
                null, null, huhiShieldsClickHandler, v -> onCloseButtonClick());
