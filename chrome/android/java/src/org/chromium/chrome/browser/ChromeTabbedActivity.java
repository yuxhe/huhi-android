...
public class ChromeTabbedActivity extends ChromeActivity implements ScreenshotMonitorDelegate {
    ...
    /**
      Huhi site banner activity request code
    */
    ...
    private @LaunchIntentDispatcher.Action int maybeDispatchExplicitMainViewIntent(
        ...
        if (intent != null &&
                intent.hasExtra(HuhiSetDefaultBrowserNotificationService.HUHI_REWARDS_SUBSTITUTE_URL)) {
            int notification_id = intent.getIntExtra(HuhiSetDefaultBrowserNotificationService.NOTIFICATION_ID_EXTRA, 0);
            ...
            mTabModelObserver = new TabModelSelectorTabModelObserver(mTabModelSelectorImpl) {
                ...
                public void didSelectTab(Tab tab, @TabSelectionType int type, int lastId) {
                    try {
                        ...
                        setHuhiShieldsColor(tab.isIncognito(), url.getHost());
                    } catch (Exception e) {
                ...
                private void closeIfNoTabsAndCloseAppWithZeroTabsEnabled(boolean isPendingClosure) {
                    if (getTabModelSelector().getTotalTabCount() == 0) {
                        ...
                        // Chrome:
                        //   1. If close all tabs closes huhi is enabled.
    ...
    private void initializeToolbarManager() {
        try (TraceEvent e = TraceEvent.scoped("ChromeTabbedActivity.initializeToolbarManager")) {
            ...
            OnClickListener huhiShieldsClickHandler = v -> {
                ...
                if (currentTab != null) {
                    try {
                        ...
                        setHuhiShieldsColor(currentTab.isIncognito(), url.getHost());
                        getHuhiShieldsMenuHandler().show((View)findViewById(R.id.huhi_shields_button)
            ...
            getToolbarManager().initializeWithNative(mTabModelSelectorImpl,
                    ...
                    bookmarkClickHandler, huhiShieldsClickHandler, null);
        ...
        try (TraceEvent e = TraceEvent.scoped("ChromeTabbedActivity.addOverviewModeObserver")) {
            ...
            mOverviewModeObserver = new EmptyOverviewModeObserver() {
                ...
                public void onOverviewModeStartedShowing(boolean showToolbar) {
                    ...
                    if (getHuhiShieldsMenuHandler() != null) getHuhiShieldsMenuHandler().hideHuhiShieldsMenu();
                }
    ...
    private class InternalIntentDelegate implements IntentHandler.IntentHandlerDelegate {
        ...
        public void processUrlViewIntent(String url, String referer, String headers,
            ...
            //substitue the URL if HUHI_REWARDS_SUBSTITUTE_URL extra data was provided
            String substituteUrl = intent.getStringExtra(HuhiSetDefaultBrowserNotificationService.HUHI_REWARDS_SUBSTITUTE_URL);
    ...
    protected TabModelSelector createTabModelSelector() {
        ...
        mTabModelSelectorTabObserver = new TabModelSelectorTabObserver(mTabModelSelectorImpl) {
            ...
            public void onPageLoadStarted(Tab tab, String url) {
                ...
                if (getActivityTab() == tab) {
                    try {
                        ...
                        setHuhiShieldsColor(tab.isIncognito(), urlCheck.getHost());
                    } catch (Exception e) {
                        setHuhiShieldsBlackAndWhite();
                    }
                }
                tab.clearHuhiShieldsCount();
            }
            ...
            @Override
            public void onHuhiShieldsCountUpdate(String url, int adsAndTrackers, int httpsUpgrades,
