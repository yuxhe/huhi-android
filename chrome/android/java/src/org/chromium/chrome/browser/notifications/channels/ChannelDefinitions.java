...
public class ChannelDefinitions {
     ...
     */
    @StringDef({ChannelId.HUHI, ChannelId.HUHI_ADS, ChannelId.BROWSER,
    ...
    public @interface ChannelId {
        String HUHI = "com.huhi.browser";
        String HUHI_ADS = "com.huhi.browser.ads";
    ...
    @StringDef({
            ChannelGroupId.GENERAL, ChannelGroupId.SITES, ChannelGroupId.HUHI_ADS
    })
    @Retention(RetentionPolicy.SOURCE)
    ...
    private static class PredefinedChannels {
        ...
        static {
            ...
            map.put(ChannelId.HUHI_ADS,
                    new PredefinedChannel(ChannelId.HUHI_ADS, R.string.notification_category_huhi_ads,
