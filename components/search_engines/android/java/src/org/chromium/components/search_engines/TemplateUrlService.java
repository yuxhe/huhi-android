...
public class TemplateUrlService {
    ...
    public static final String PREF_STANDARD_SEARCH_ENGINE = "huhi_standard_search_engine";
    public static final String PREF_STANDARD_SEARCH_ENGINE_KEYWORD = "huhi_standard_search_engine_keyword";
    public static final String PREF_PRIVATE_SEARCH_ENGINE = "huhi_private_search_engine";
    public static final String PREF_PRIVATE_SEARCH_ENGINE_KEYWORD = "huhi_private_search_engine_keyword";
    public static final String DSE_NAME = "Google";
    public static final String DSE_KEYWORD = "google.com";
    public static final String PREF_SHOW_DDG_OFFER = "huhi_show_ddg_offer";
    public static final String PREF_DDG_OFFER_SHOWN = "huhi_ddg_offer_shown";
    public static final String PREF_SET_QWANT_SE = "huhi_set_qwant_se";
    public static final String PREF_SET_DDG_SE = "huhi_set_ddg_se";
